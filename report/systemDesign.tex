...
Each user gets a fair share of the resources to a maximum of one machine per user. If our number of machines gets depleted, new jobs will be put in a queue that will have to wait to be served. 